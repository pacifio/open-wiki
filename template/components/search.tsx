      ...
      <Presence present={open}>
        <div
          className={cn(
            ...
            'fixed inset-y-0 end-0 w-(--ai-chat-width) border-s shadow-2xl',
            'max-lg:inset-x-2 max-lg:top-4 max-lg:bottom-auto max-lg:w-auto max-lg:border max-lg:rounded-2xl max-lg:shadow-xl',
            open
              ? 'animate-[ask-ai-open_200ms_ease-out_forwards]'
              : 'animate-[ask-ai-close_200ms_ease-in_forwards]',
          )}
        >
          <div className="flex flex-col size-full p-3 max-lg:max-h-[80dvh]">
            <AISearchPanelHeader />
